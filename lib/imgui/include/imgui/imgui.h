...
namespace ImGui
{
    ...
    // Same as CollapsingHeader, but it DOES call TreePush
    IMGUI_API bool          Als_CollapsingHeaderTreeNode(const char* label, ImGuiTreeNodeFlags flags = 0); 
    IMGUI_API bool          Als_CollapsingHeaderTreeNode(const char* label, bool* p_open, ImGuiTreeNodeFlags flags = 0);
    ...
    IMGUI_API bool          Als_IsTreeNodeToggled();
